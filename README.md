...
- Part 1 — Toward a Four-Layer Architecture ([article](docs/articles/Toward%20a%20Four-Layer%20Architecture%20for%20Self-Hosted%20Enterprise%20AI%20Harnesses.md) / [Habr (Russian)](https://habr.com/p/1057942/))
- Part 2 — Identity, Policy & Audit _(planned)_
- Part 3 — Agent Loop (ReAct) _(planned)_
- Part 4 — Execution Layer _(planned)_
- Part 5 — Multi-tenancy _(planned)_
- Part 6 — Security Boundaries _(planned)_
- Part 7 — Kubernetes Deployment _(planned)_
- Part 8 — Lessons Learned _(planned)_
...
```
docs/articles/    Published article series
diagrams/         Architecture diagrams
```

Implementation artifacts, examples and ADRs will be added incrementally as the accompanying article series progresses.
